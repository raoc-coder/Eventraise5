        ...
        <div className="space-y-8">
          ...
          <Card className="card-soft">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-green-400 mb-3">Account Security</h3>
                <ul className="text-gray-300 space-y-2">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-400 mb-3">Content Guidelines</h3>
                <ul className="text-gray-300 space-y-2">
          ...
          <Card className="card-soft">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-purple-400 mb-3">Donations</h3>
                <ul className="text-gray-300 space-y-2">
                  ...
                  <li>• We do not charge fees on donations (fees may apply to campaign creators)</li>
                  <li>• Donors will receive receipts for tax purposes</li>
                </ul>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-orange-400 mb-3">Campaign Funds</h3>
                <ul className="text-gray-300 space-y-2">
          ...
          <Card className="card-soft">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-yellow-400 mb-3">Platform Availability</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-red-400 mb-3">Campaign Responsibility</h3>
                <p className="text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-orange-400 mb-3">Limitation of Liability</h3>
                <p className="text-gray-300">
          ...
          <Card className="card-soft">
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-cyan-400 mb-3">By You</h3>
                  <p className="text-gray-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-red-400 mb-3">By Us</h3>
                  <p className="text-gray-300">
